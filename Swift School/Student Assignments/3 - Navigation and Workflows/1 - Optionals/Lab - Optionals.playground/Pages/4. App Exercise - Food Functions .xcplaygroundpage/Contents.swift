...
func nutrients(eat: String) -> Meal? {
    let breakfastItems: Meal? = meals[eat]
    if let breakfastItems = breakfastItems {
        return breakfastItems
    }
    return nil
}
print(nutrients(eat: "Breakfast"))
print(nutrients(eat: "Lunch"))
