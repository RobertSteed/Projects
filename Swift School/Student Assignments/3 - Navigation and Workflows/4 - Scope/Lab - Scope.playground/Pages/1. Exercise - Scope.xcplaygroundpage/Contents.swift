...
// it will get a compiling error becuase you are asking the computer to print the value outside of the scope of the loop
...
//both will compile because the first print statement is within the scope of the loop while the second is in the scope of the declared variable
...
greeting(greeting: "Hey there", name: "John")
