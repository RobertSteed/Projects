...
case 121...140:
    print("you are in the light zone. Activity in this zone help improve basic endurance and fat burning")
case 141...160:
    print("You are in the moderate zone. Activity in this zone helps improve aerobic fitness")
case 161...180:
    print("you are in the hard zone. Activity in this zone increases maximum performace capacity for shorter sessions")
case 181...200:
    print("You are in the maximum zone. Activity in this zone helps fit athletes develope speed")
default:
    print("lets get working")
}
