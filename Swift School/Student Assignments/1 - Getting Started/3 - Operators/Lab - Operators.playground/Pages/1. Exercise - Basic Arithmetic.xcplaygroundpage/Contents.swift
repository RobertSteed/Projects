...
//It differs becuase it is actually giving a decimal number and not just rounding down to the nearest whole number
/*:
...
print(even)
print(odd)
// you could use the remainder operator to determine what is even or odd because we know that Swift will always round down to the smaller number
