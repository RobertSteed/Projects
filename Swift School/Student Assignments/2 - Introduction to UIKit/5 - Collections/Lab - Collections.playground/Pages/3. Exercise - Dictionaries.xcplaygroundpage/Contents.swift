...
var shapesArray: [String] = ["Square", "Triangle", "Cirlce"]
var colorsArray: [String] = ["Blue", "Red", "Green"]
var organize: [String: [String]] = ["Shapes": shapesArray, "Colors": colorsArray]
print(organize)
