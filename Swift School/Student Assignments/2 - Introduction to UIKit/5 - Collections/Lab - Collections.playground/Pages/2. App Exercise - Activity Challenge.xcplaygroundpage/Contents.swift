 ...
 */
var walkingChallenges: [String] = ["Walk up two flights of stairs", "Take 10_000 steps a day"]
var runningChallenges: [String] = ["Run 2 miles a day", "Sprint 60 seconds straight"]
...
let secondElement = challenges[1][0]
...
var committedChallenges: [String] = ["Eat 10_000 hot dogs", "Gain 200k pounds in muscle", "Swim in a protien shake pool"]
...
if (committedChallenges.isEmpty) {
    ...
    print("The Challenge you have chosen is <Eat 10_000 hot dogs>")
} else {
