...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser: User = User(userName: "rob", email: "rob@rob.com", age: 24)
...
User.logIn(user: User(userName: "asdf", email: "asdfg", age: 423))

User.currentUser.userName

var Rob = User(userName: "kojkh", email: "lkjhg", age: 400)
