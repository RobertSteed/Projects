...
var today = RunningWorkout(distance: 1600, time: 10.30, elevation: 3_125)
print(today.averageMileTime)
...
struct Steps {
    var steps: Int {
        ...
        willSet {
            print("Congradulations! You just beat your goal!")
        }
    }
    var goal: Int
...
var today1 = Steps(steps: 9_999, goal: 10_000)
print(today1)
today1.takeStep()
