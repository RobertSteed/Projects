...
var favoriteBook = Book(title: "12 Rules For Life", author: "Jordan Peterson", pages: 500, price: 20.99)
...
var firstLaptop = Laptop (yearPurchased: 2022)
var secondLaptop = Laptop (yearPurchased: 2021)
print(firstLaptop)
print(secondLaptop)
...
var numbers = Height(heightInInches: 12)
var numbers2 = Height(heightInCentimeters: 120)
