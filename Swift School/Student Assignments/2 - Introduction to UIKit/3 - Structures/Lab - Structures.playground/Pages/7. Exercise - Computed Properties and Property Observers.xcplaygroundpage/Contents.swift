...
var shape = Rectangle(width: 5, height: 10)
print(shape)
print(shape.area)
...
struct Height {
    var heightInInches: Double {
        didSet {heightInCentimeters = heightInInches * 2.54}
    }
    
    var heightInCentimeters: Double {
        didSet { heightInInches = heightInCentimeters / 2.54}
...
var me = Height(heightInInches: 70)
print(me.heightInCentimeters)
