...
var states: [String: String] = ["Utah": "Salt Lake City", "Wyoming": "Cheyenne", "Washington": "Olympia"]
for (stateNames, stateCapital) in states {
    print("The capital of \(stateNames) is \(stateCapital)")
    if stateNames == "Utah" {
