...
var urlComponents = URLComponents(string: "https://itunes.apple.com/search?term=jack+johnson")

var queryItems: [URLQueryItem] = urlComponents?.queryItems ??  []

query.map { (name, value) in
...
var url = URL(string: "https://itunes.apple.com/search?term=jack+johnson")!
